            ...
            case 1:
                if (args[0].equalsIgnoreCase("help")) {
                    if (CorePlusAPI.getPlayerManager().hasPerm(sender, "slimechunkplus.use")) {
                        ...
                        if (CorePlusAPI.getPlayerManager().hasPerm(sender, "slimechunkplus.command.checkslime.other")) {
                            CorePlusAPI.getLangManager().sendLangMsg(ConfigHandler.getPluginName(), ConfigHandler.getPrefix(),
                                    ConfigHandler.getConfigPath().getMsgCheckSlime(), sender);
                            CorePlusAPI.getLangManager().sendLangMsg(ConfigHandler.getPluginName(), ConfigHandler.getPrefix(),
                                    ConfigHandler.getConfigPath().getMsgCheckSlimeOther(), sender);
                        } else if (CorePlusAPI.getPlayerManager().hasPerm(sender, "slimechunkplus.command.checkslime")) {
                            CorePlusAPI.getLangManager().sendLangMsg(ConfigHandler.getPluginName(), ConfigHandler.getPrefix(),
                                    ConfigHandler.getConfigPath().getMsgCheckSlime(), sender);
                        }
                        CorePlusAPI.getLangManager().sendMsg(ConfigHandler.getPrefix(), sender, "");
